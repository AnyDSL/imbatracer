...
int estimate_light_path_len(const Scene& scene, bool use_gpu, int probes) {
    UniformLightTileGen<ProbeState> tile_gen(scene.light_count(), probes, 512);
    DeferredScheduler<ProbeState> scheduler(&scene, 4, 256, use_gpu, tile_gen.sizeof_ray_gen());
